...
public class PilotDetectionVariableRepositoryTest {
	...
	public void testFindDerived () {
		...
		List<PilotDetectionVariable> result = pilotDetectionVariableRepository.findDerived("LCC", dvt1);		
		Assert.assertNotNull(result);
		Assert.assertEquals(2, result.size());
		
		result = pilotDetectionVariableRepository.findDerived("LCC", dvt2);		
		Assert.assertNotNull(result);
		Assert.assertEquals(1, result.size());
		
		result = pilotDetectionVariableRepository.findDerived("ATH", dvt1);		
		Assert.assertNotNull(result);
		Assert.assertEquals(1, result.size());
		
		result = pilotDetectionVariableRepository.findDerived("LCC", dvt3);		
		Assert.assertNotNull(result);
		Assert.assertEquals(0, result.size());
		
		result = pilotDetectionVariableRepository.findDerived("ATH", dvt2);		
		Assert.assertNotNull(result);
		Assert.assertEquals(0, result.size());
