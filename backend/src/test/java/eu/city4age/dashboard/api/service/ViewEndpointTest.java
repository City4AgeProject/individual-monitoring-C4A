...
public class ViewEndpointTest {
	
	static protected Logger logger = LogManager.getLogger(ViewEndpointTest.class);
	...
	public void getDiagramDataTest() throws Exception {
		...
		Response response = viewEndpoint.getDiagramData(uir1.getId(), dv1.getId());
