...
create table testtest.time_interval (id int8 not null, interval_start timestamptz, interval_end timestamptz, typical_period varchar(3), created timestamp, primary key (id), unique (interval_start, typical_period));
