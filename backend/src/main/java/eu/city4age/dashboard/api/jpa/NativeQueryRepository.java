...
public interface NativeQueryRepository extends GenericRepository<NativeQuery, Long> {
	...
	List<Object[]> computeAllNuis(@Param("startOfMonth") Timestamp startOfMonth, @Param("endOfMonth") Timestamp endOfMonth);
	
	@Query(nativeQuery = true)
	List<Object[]> computeAllGess(@Param("startOfMonth") Timestamp startOfMonth, @Param("endOfMonth") Timestamp endOfMonth);

	@Query(nativeQuery = true)
	List<Object[]> computeAllGfvs(@Param("startOfMonth") Timestamp startOfMonth, @Param("endOfMonth") Timestamp endOfMonth, @Param("detectionVariableType") DetectionVariableType detectionVariableType);
