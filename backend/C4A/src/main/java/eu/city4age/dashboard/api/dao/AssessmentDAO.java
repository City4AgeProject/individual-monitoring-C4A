...
public interface AssessmentDAO extends BaseDAO {
	...
	List<Assessment> getAssessmentsForSelectedDataSet(final List<Long> geriatricFactorIds, final List<Boolean> status, final Short authorRoleId, final OrderBy orderBy);
