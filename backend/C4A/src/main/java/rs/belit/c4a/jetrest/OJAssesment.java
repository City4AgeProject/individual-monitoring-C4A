...
public class OJAssesment {
    ...
    public Response lastFiveForInterval(@QueryParam(value = "intervalStart") String intervalStart,
        ...
        alertSerie.setName("Assessments");
        ...
        warningSerie.setName("Assessments");
        ...
        commentSerie.setName("Assessments");
        commentSerie.setSource("images/flag-gray.png");
        series.add(commentSerie);
        
        for (AssesmentForLastFives assesmentForLastFives : toLose) {
            Item item = new Item();
            item.setId(assesmentForLastFives.getGef_id());
            item.setValue(assesmentForLastFives.getGef_value());
            List<Assessment> assesments = new ArrayList<Assessment>();
            for (AssesmentForLastFives assesmentForLastFivesAssesments : toLose) {
                Assessment assesment = new Assessment();
                assesment.setRiskStatus(assesmentForLastFivesAssesments.getRisk_status());
                assesment.setDataValidity(assesmentForLastFivesAssesments.getData_validity_status());
                assesment.setFrom(String.valueOf(assesmentForLastFivesAssesments.getAuthor_id()));
                ...
                if("V".equals(assesment.getDataValidity())) {
                    ...
                    assesment.setDataValidityImage("images/questionable_data.png_data.png");
                }
            }
            item.setAssessmentObjects(assesments);
        }
