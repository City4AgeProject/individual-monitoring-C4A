...
create table testtest.assessment_audience_role (id int8 not null, assessment_id int8 not null, role_id int8 not null, assigned timestamp not null, primary key (id));
